...
if __name__=='__main__':
    ...
    folder = "SNS_iniflux_study_2"
    
    use_custom_grid = False
    
    custom_grid_name = "nogit_SNS_solidification_grid_100_leftovers.csv"
        ...
        custom_grid_flat = [
            {
                ...
                "delivery.elements.H_ppmw": "100ppm"
            }
            for row in reader
        ]
    ...
    # Execution limits
    max_jobs = 11 # maximum number of concurrent tasks
    ...
    if not use_custom_grid: 
        ...
        pg.add_dimension("iniflux", "interior.F_initial")
        pg.set_dimension_direct("iniflux", np.logspace(7,12,6))
