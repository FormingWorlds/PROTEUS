...
# Scale flux to match Baraffe tracks at t=t0
cfg["tr1b"]["star"]["bol_scale"] = 3.628e+04 / 4.439e+04
cfg["tr1e"]["star"]["bol_scale"] = 5.648e+03 / 6.909e+03
cfg["tr1a"]["star"]["bol_scale"] = 1.687e+06 / 4.218e+06
...
for p in cfg.keys():
    cfg[p]["params"]["stop"]["time"]["maximum"] = (cfg[p]["star"]["mors"]["age_now"] - cfg[p]["star"]["age_ini"])*1e9
