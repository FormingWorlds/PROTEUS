...
if __name__=='__main__':
    ...
    config = "planets/nogit_fiducial_sub_Neptune_metalicity.toml"
    ...
    if not use_custom_grid: 
        ...
        pg.add_dimension("metallicity", "delivery.elements.metallicity")
        pg.set_dimension_direct("metallicity", np.logspace(4,5,11))
