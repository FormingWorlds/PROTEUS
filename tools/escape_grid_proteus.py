...
if __name__=='__main__':
    ...
    pg.add_dimension("Module atmosphere", "atmos_clim.module")
    ...
    pg.set_dimension_direct("Redox state", [-4, 0, 4])

    pg.add_dimension("C/H ratio", "delivery.elements.CH_ratio")
    pg.set_dimension_direct("C/H ratio", [0.1, 1.0, 2.0]) #[0.1, 1.0, 2.0])

    pg.add_dimension("H inventory", "delivery.elements.H_oceans")
    pg.set_dimension_direct("H inventory", [1, 5, 10])

    pg.add_dimension("M_star", "star.mass")
    pg.set_dimension_direct("M_star", [1.0]) #[0.1, 0.5, 1.0]
