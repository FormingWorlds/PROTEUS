...
supported together. `proteus doctor` checks your installation against these
pins, and `proteus update` aligns your installation to them.
...
<!-- Badges link to the minimum-bound release on PyPI or GitHub. -->
<!-- To regenerate after a version bump: python tools/generate_version_badges.py -->

| Module | Role | Pin | Docs |
|--------|------|-----|------|
| fwl-aragog | Interior thermal evolution | [![Aragog](https://img.shields.io/badge/fwl--aragog-%3E%3D26.05.13-blue)](https://pypi.org/project/fwl-aragog/26.5.13/) | [Docs](https://proteus-framework.org/aragog/) |
| fwl-zalmoxis | Interior structure | [![Zalmoxis](https://img.shields.io/badge/fwl--zalmoxis-%3E%3D26.05.13-blue)](https://pypi.org/project/fwl-zalmoxis/26.5.13/) | [Docs](https://proteus-framework.org/Zalmoxis/) |
| fwl-calliope | Volatile outgassing | [![CALLIOPE](https://img.shields.io/badge/fwl--calliope-branch%3A%20tl%2Ffo2--source--framework-orange)](https://github.com/FormingWorlds/CALLIOPE/tree/tl/fo2-source-framework) | [Docs](https://proteus-framework.org/CALLIOPE/) |
| fwl-janus | 1D convective atmosphere | [![JANUS](https://img.shields.io/badge/fwl--janus-%3E%3D24.11.05-blue)](https://pypi.org/project/fwl-janus/24.11.5/) | [Docs](https://proteus-framework.org/JANUS/) |
| fwl-mors | Stellar evolution | [![MORS](https://img.shields.io/badge/fwl--mors-%3E%3D26.01.02-blue)](https://pypi.org/project/fwl-mors/26.1.2/) | [Docs](https://proteus-framework.org/MORS/) |
| fwl-zephyrus | Atmospheric escape | [![ZEPHYRUS](https://img.shields.io/badge/fwl--zephyrus-%3E%3D25.03.11-blue)](https://pypi.org/project/fwl-zephyrus/25.3.11/) | [GitHub](https://github.com/FormingWorlds/ZEPHYRUS) |
| fwl-vulcan | Atmospheric chemistry | [![VULCAN](https://img.shields.io/badge/fwl--vulcan-%3E%3D26.04.22-blue)](https://pypi.org/project/fwl-vulcan/26.4.22/) | [GitHub](https://github.com/FormingWorlds/VULCAN) |
...
| SOCRATES | Spectral radiative transfer (Fortran) | [![SOCRATES](https://img.shields.io/badge/SOCRATES-e7133ff7-green)](https://github.com/FormingWorlds/SOCRATES/commit/e7133ff7388847c7939b38572c6e91cd05d5b755) | [GitHub](https://github.com/FormingWorlds/SOCRATES) |
| SPIDER | Interior evolution, T-S formulation (C) | [![SPIDER](https://img.shields.io/badge/SPIDER-c9a3fd43-green)](https://github.com/FormingWorlds/SPIDER/commit/c9a3fd4301c7008291d4f4921506d36b6288f8ca) | [Docs](https://proteus-framework.org/SPIDER/) |
...
| Obliqua | Orbital evolution and tides (Julia) | — | [GitHub](https://github.com/FormingWorlds/Obliqua) |
| PLATON | Synthetic observations | — | [Docs](https://platon.readthedocs.io/) |
