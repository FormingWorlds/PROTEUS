...
| `spectral_group` | str | `"Honeyside"` | Opacity k-table set (shared by AGNI and JANUS; see [options here](https://proteus-framework.org/SOCRATES/Reference/proteus_spectral_file_reference.html)) |
