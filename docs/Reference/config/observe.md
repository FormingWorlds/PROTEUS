...
<!-- BEGIN GENERATED: config-table [observe] -->
...
<!-- END GENERATED: config-table [observe] -->
...
<!-- BEGIN GENERATED: config-table [observe.petitRADTRANS] -->
<!-- Generated by tools/generate_config_reference.py; edit src/proteus/config/, not this table -->
| Parameter | Type | Default | Description |
|---|---|---|---|
| `line_opacity_mode` | str | `"c-k"` | Opacity treatment: 'c-k' (correlated-k) or 'lbl' (line-by-line). Choices: `"c-k"`, `"lbl"`. |
...
| `silent` | bool | `true` | Suppress petitRADTRANS stdout/stderr during Radtrans initialization. |
<!-- END GENERATED: config-table [observe.petitRADTRANS] -->
...
| Parameter | Type | Default | Description |
|---|---|---|---|
| `module` | str or none | `none` | Accretion module to use. Currently only None is supported. Choices: `none`. |
<!-- END GENERATED: config-table [accretion] -->

## Constraints

<!-- BEGIN GENERATED: config-constraints observe -->
<!-- Generated by tools/generate_config_reference.py; edit src/proteus/config/, not this table -->
...
<!-- END GENERATED: config-constraints observe -->
