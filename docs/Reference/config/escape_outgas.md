...
| `vapourise` | bool | `false` | Enable rock vapourisation. Requires `LAVA_DIR` and `FC_DIR`; see [Installation: optional modules](../../How-to/optionalmodules_installation.md#rock-vapours-lavatmos-thermoenginelite) |
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `T_min` | float | `1500.0` | Minimum LavAtmos surface temperature \[K]; the vapourisation temperature is clamped up to this floor |
