...
| Parameter | Type | Default | Description |
|---|---|---|---|
| `b_width` | float | `0.5` | Scale width of the bottom heating decay profile \[dimensionless\]. Must be > 0. |
| `t_width` | float | `0.03` | Scale width of the top heating decay profile \[dimensionless\]. Must be > 0. |
