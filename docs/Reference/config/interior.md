...
| `eddy_diffusivity_thermal` | float | `1.0` | Thermal eddy diffusivity control. A positive value multiplies the internally-computed eddy diffusivity; a negative value pins it to \|value\| in m^2/s. Matches SPIDER -eddy_diffusivity_thermal (1.0 default). |
| `eddy_diffusivity_chemical` | float | `1.0` | Chemical eddy diffusivity control. A positive value multiplies the internally-computed eddy diffusivity; a negative value pins it to \|value\| in m^2/s. Matches SPIDER -eddy_diffusivity_chemical (1.0 default). |
