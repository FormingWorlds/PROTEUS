...
| `separation_viscosity` | str | `"melt"` | Drag viscosity for gravitational separation: 'melt' (single-phase liquid viscosity, SPIDER parity) or 'mixture' (rheological-transition- blended bulk viscosity). Choices: `"melt"`, `"mixture"`. |
