...
| `atm_levels_stale` | `1` | consecutive iterations without a converged solve of this run | `atmos_clim/wrapper.py` | always |   |
...
| `g_xuv` | `m s-2` | gravity at R_xuv | `atmos_clim/agni.py`<br>`atmos_clim/dummy.py`<br>`atmos_clim/janus.py` | atmos_clim.module = "agni"; atmos_clim.module = "dummy"; atmos_clim.module = "janus" |   |
