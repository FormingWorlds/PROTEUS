...
See the section on running grids in the PROTEUS [usage guide](../usage.md#running-grids-of-simulations). These instructions will detail how to submit grids to the nodes via SLURM.
