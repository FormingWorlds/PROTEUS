    ...
    def _run_proteus(
        ...
        **config_overrides,
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Ensure required data exists when using ARAGOG, AGNI, MORS, or
            # Zalmoxis (download if missing). Runs locally and in CI; no-op or
            # quick when data already present.
            if (
                ...
                or runner.config.star.module == 'mors'
            ):
