...
def _skip_if_no_mors_data() -> None:
    """Skip if the mors spada tracks aren't materialized under FWL_DATA."""
    ...
    if not spada.is_dir():
        pytest.skip(f'mors spada tracks not present at {spada}')
