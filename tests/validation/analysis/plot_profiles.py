...
def plot_interior_TP_comparison():
    ...
    fig.suptitle("Interior Temperature–Pressure Profiles: Evolution Over Time",
    ...
    panels = [
        ...
        ("A_M5.0_CMF0.5_AW",    "A_M5.0_CMF0.325_ZAL",  "5.0 M$_\\oplus$ (AW CMF=0.5 vs ZAL CMF=0.325)"),
        ("A_M3.0_CMF0.1_ZAL",   "A_M5.0_CMF0.1_ZAL",    "CMF=0.1: 3.0 vs 5.0 M$_\\oplus$ (ZAL only)"),
    ]
...
def plot_melt_profiles():
    ...
    fig.suptitle("Melt Fraction Radial Profiles: Evolution Over Time",
                 fontsize=14, fontweight="bold", y=0.98)
...
def plot_interior_phase_diagram():
    ...
    fig, axes = plt.subplots(2, 3, figsize=(18, 10))
    fig.suptitle("Interior Phase Diagram: Temperature vs Solidus/Liquidus",
                 fontsize=14, fontweight="bold", y=0.98)
    ...
    for idx, case_name in enumerate(case_list):
        ...
        ax.fill_betweenx(P0, T_sol, T_liq, alpha=0.15, color="orange",
                         label="Mushy zone")
...
def plot_coupled_TP():
    ...
    fig, axes = plt.subplots(2, 3, figsize=(18, 10))
    fig.suptitle("Coupled Interior + Atmosphere T–P Structure",
                 fontsize=14, fontweight="bold", y=0.98)
    ...
    for idx, case_name in enumerate(case_list):
        ...
        custom = [Line2D([0],[0], color="gray", linewidth=1.5, linestyle="-", label="Interior"),
...
def plot_transport_properties():
    ...
    fig, axes = plt.subplots(2, 3, figsize=(18, 10))
    fig.suptitle("Transport Properties: Eddy Diffusivity $\\kappa_h$ and Thermal Expansion $\\alpha$",
                 fontsize=14, fontweight="bold", y=0.98)
    ...
    for idx, case_name in enumerate(case_list):
        ...
        ax.semilogy(r, np.clip(kappah, 1e-10, None), color=color1, linewidth=1.5,
                    label="$\\kappa_h$ [m²/s]")
        ax2 = ax.twinx()
        ax2.plot(r, alpha * 1e5, color=color2, linewidth=1.5,
