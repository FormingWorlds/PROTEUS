...
_REVIEWED_NEUTRAL = frozenset(
    {
        ...
        'interior_energetics.aragog.activation_energy',
        'interior_energetics.aragog.activation_volume',
        'interior_energetics.aragog.arrhenius_t_ref',
        ...
        'interior_energetics.aragog.enabled',
        'interior_energetics.aragog.entropy_step_cap',
        'interior_energetics.aragog.lid_base_mode',
        'interior_energetics.aragog.lid_base_temperature',
        'interior_energetics.aragog.lid_contrast_coeff',
        ...
        'interior_energetics.aragog.stress_closure_mode',
        'interior_energetics.aragog.temperature_step_cap',
        'interior_energetics.aragog.tolerance_struct',
        'interior_energetics.aragog.viscosity_max_log10',
        'interior_energetics.aragog.yield_stress_c',
        'interior_energetics.aragog.yield_stress_max',
        'interior_energetics.aragog.yield_stress_mu',
