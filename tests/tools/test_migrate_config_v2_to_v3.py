...
_REVIEWED_NEUTRAL = frozenset(
    {
        ...
        'interior_energetics.aragog.rheology.activation_energy',
        'interior_energetics.aragog.rheology.activation_volume',
        'interior_energetics.aragog.rheology.activation_volume_decay_pressure',
        'interior_energetics.aragog.rheology.arrhenius_t_ref',
        'interior_energetics.aragog.rheology.enabled',
        'interior_energetics.aragog.rheology.interior_flux_fraction',
        'interior_energetics.aragog.rheology.lid_base_mode',
        'interior_energetics.aragog.rheology.lid_base_temperature',
        'interior_energetics.aragog.rheology.lid_contrast_coeff',
        'interior_energetics.aragog.rheology.lid_mask_width_cells',
        'interior_energetics.aragog.rheology.phi_visc_single',
        'interior_energetics.aragog.rheology.stress_closure_mode',
        'interior_energetics.aragog.rheology.viscosity_max_log10',
        'interior_energetics.aragog.rheology.water_prefactor',
        'interior_energetics.aragog.rheology.yield_stress_c',
        'interior_energetics.aragog.rheology.yield_stress_max',
        'interior_energetics.aragog.rheology.yield_stress_mu',
        'interior_energetics.aragog.rheology.yield_switch_width',
