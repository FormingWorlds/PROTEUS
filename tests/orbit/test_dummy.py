...
def test_less_than_threshold_heating_scales_with_melt_fraction():
    ...
    result = run_dummy_tides(config, interior)
...
def test_equal_to_threshold_produces_zero_heating():
    ...
    run_dummy_tides(config, interior)
    ...
    run_dummy_tides(config, interior_below)
...
def test_no_cells_meet_condition_keeps_zero_heating():
    ...
    run_dummy_tides(config, interior_mixed)
...
def test_phi_array_unchanged_by_heating_calculation():
    """run_dummy_tides updates tides but leaves melt fractions untouched.
...
def test_returns_imk2_from_config():
    ...
    result2 = run_dummy_tides(config2, interior2)
