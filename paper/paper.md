...
- Interface: CALLIOPE [@bower22; @shorttle24; @nicholls25a] and atmodeller [@bower25] compute the redox-, temperature-, and pressure-dependent in- and outgassing of C-H-N-O-S volatiles; LavAtmos [@vanbuchem23] optionally adds rock vapour.
...
- Environment: MORS [@johnstone21] evolves the stellar luminosity and spectrum; LovePy [@hay19; @nicholls25c] and [Obliqua](https://github.com/FormingWorlds/Obliqua) compute tidal heating and orbital evolution; [Morrigan](https://github.com/FormingWorlds/Morrigan) [@kimura25] grows the planet by giant impacts.
