...
- Interior: Zalmoxis computes the interior structure and gravity profile; Aragog [@sastre26] and SPIDER [@bower18] solve the thermal evolution of the partially molten mantle in a temperature and an entropy formalism, respectively, and a boundary-layer model offers a fast alternative.
...
- Environment: MORS [@johnstone21] evolves the stellar luminosity and spectrum; LovePy [@hay19; @nicholls25c] and Obliqua compute tidal heating and orbital evolution; Morrigan [@kimura25] grows the planet by giant impacts.
