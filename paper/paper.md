...
PROTEUS has made several behaviours visible that appear only when the subsystems are coupled. A self-limiting feedback between irradiation, tidal heating, and mantle rheology prolongs magma oceans [@nicholls25c]; the tides of the early Moon did so on the Hadean Earth [@vandijk26]. Convective shutdown forms deep radiative layers above a magma ocean [@nicholls25a]. On young planets the contest between outgassing and escape decides between a bare rock and a water- or carbon-rich atmosphere [@postolec26a]. Most rocky sub-Neptunes keep molten interiors [@calder26], and a crystallising interior contracts by about 10 per cent [@lichtenberg26]. Redox-driven re-inflation expands the atmospheres of ultra-short-period super-Earths late in their lives [@cesario26].
