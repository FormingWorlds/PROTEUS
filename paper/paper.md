...
Each of these feedbacks rests on laboratory-measured material properties, from equations of state [@attia26] to volatile solubilities [@sossi23; @suer23] and gas opacities. New experiments extend these properties into conditions without Solar System counterpart [@lichtenberg25]. A model must therefore accept a new measurement without being rewritten.

The same magma ocean stage set the starting conditions of the Solar System terrestrial planets, where later evolution has overwritten its record [@lichtenberg23]; strongly irradiated exoplanets expose this stage today. PROTEUS connects the two: it reproduces the early divergence of Earth and Venus [@chili26] and the onset of habitable conditions on the Hadean Earth [@vandijk26]. Its wide range of interior compositions and geochemistries [@nicholls24; @lichtenberg26] spans the reduced mantle of Mercury and the oxidised mantle of Mars. PROTEUS serves three uses: prediction for JWST and its successors, interpretation of a spectrum or density as the outcome of a history, and tests of laboratory data at planetary scale. The successors are PLATO [@rauer25], Ariel [@tinetti18], and the Roman Space Telescope [@tamburo23]. Later come the extremely large telescopes, LIFE [@quanz22], and the Habitable Worlds Observatory [@stark24].
