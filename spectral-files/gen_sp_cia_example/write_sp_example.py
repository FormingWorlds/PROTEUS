...
f.write('Ccorr_k -F pt_cont -CIA H2-H2_2011.cia -R 1 10 -i 1.0 -ct 23 23 1.0e2 -t 1.0e-2 -s ' + spec_file_name + ' +p -lk -o h2_o -m h2_m -L h2_lbl.nc' + '\n')
