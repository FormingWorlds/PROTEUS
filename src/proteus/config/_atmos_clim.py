...
class Agni:
    ...
    surf_material : str
        File name for material used to set surface single-scattering properties. Set to 'greybody' to use `surf_greyalbedo`. See [documentation](https://fwl-proteus.readthedocs.io/en/latest/data/#surfaces) for potential options.
    num_levels: str
