...
observer_bands = {
    ...
    'NIRISS': {'SOSS': [0.6, 2.8], 'WFSS': [0.8, 2.2], 'AMI': [2.8, 4.8]},
    ...
    'ARIEL': {'AIRS0': [1.95, 3.9], 'AIRS1': [3.9, 7.8]},
    ...
    'PLATO': {'blue': [0.500, 0.675], 'red': [0.675, 1.125]},
    ...
    'GEMINI-N': {'MAROON-X': [0.5, 0.92], 'IGRINS-2': [1.49, 2.46]},
    ...
    'VLT': {'ESPRESSO': [0.38, 0.788], 'SPHERE': [0.95, 2.32]},
    ...
    'ELT': {'HARMONI': [0.47, 2.45], 'MICADO': [0.8, 2.4], 'ANDES': [0.40, 1.80]},
}
...
def sample_output(
    handler: Proteus, extension: str = '_atm.nc', tmin: float = 1.0, nsamp: int = 8
):
