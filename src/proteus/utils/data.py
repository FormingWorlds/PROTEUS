            ...
            if src == "solar":
                ...
                if config.star.mors.star_name.lower() != "sun":
                    ...
                    if muscles_ok:
                        ...
                        log.info("To use a MUSCLES spectrum, check the available MUSCLES spectra at https://proteus-framework.org/PROTEUS/data.html and set star.mors.spectrum_source = 'muscles'.")
                ...
                if not muscles_ok:
                    ...
                    log.error("Check the MUSCLES available MUSCLES spectra at https://proteus-framework.org/PROTEUS/data.html to verify the star name.")
